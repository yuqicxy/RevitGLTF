...
namespace Nvidia.TextureTools
{
	...
	public class Compressor
	{
		...
		[DllImport("nvtt"), SuppressUnmanagedCodeSecurity]
		private extern static bool nvttBumpMapToNormalMap(string inputString, string outputStrinig);
		...
		public bool BumpMapToNormalMap(string input, string output)
		{
			return nvttBumpMapToNormalMap(input, output);
		}
